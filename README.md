...
<p align="center">
  <img src="src/assets/your/main-logo-or-screenshot.png" alt="KABINET Logo" width="600">
</p>
...
<p align="center">
  <img src="src/assets/use-case-diagram.png" alt="Use-case диаграмма">
  <br><i>Рисунок 1 – Use-case диаграмма</i>
</p>

### Функциональная диаграмма
<p align="center">
  <img src="src/assets/functional-diagram.png" alt="Функциональная диаграмма">
  <br><i>Рисунок 2 – Функциональная диаграмма</i>
</p>

### Диаграмма сущностей (ER-диаграмма)
<p align="center">
  <img src="src/assets/entity-diagram.png" alt="Диаграмма сущностей">
...
<p align="center">
  <img src="src/assets/screenshot-4-1.png" width="45%" alt="Кабинет врача">
  <img src="src/assets/screenshot-4-2.png" width="45%" alt="Заметки врача">
...
<p align="center">
  <img src="src/assets/screenshot-5-1.png" width="80%" alt="Панель администратора">
  <br><i>Рисунок 5.1 – Панель администратора</i>
</p>

### Просмотр и редактирование
<p align="center">
  <img src="src/assets/screenshot-5-2-2.png" width="45%" alt="Просмотр клиента">
  <img src="src/assets/screenshot-5-3-2.png" width="45%" alt="Редактирование">
...
<p align="center">
  <img src="src/assets/screenshot-5-6-2.png" width="45%" alt="Поиск по фамилии">
  <img src="src/assets/screenshot-5-6-3.png" width="45%" alt="Фильтр по полу">
